...
export const state = {
  ...
  isCloudflareCardMode: false,
  cloudflareCardSequenceToken: 0,
  rightMonitorCloudflareIconOverlayEl: null,
  rightMonitorCornerpieceOverlayEl: null,
  leftMonitorCloudflareCardEl: null,
  leftMonitorCloudflareQuadrantEl: null,
  middleMonitorCloudflareOverlayEl: null,
  middleMonitorCloudflareVideoEl: null,
  middleMonitorCloudflareStaticVideoEl: null,
  middleMonitorShrimpDancerOverlayEl: null,
  isMiddleMonitorCloudflareLoopRunning: false,
  ...
  cornerScoreRunStartTime: null,
  cornerScoreRunBounces: 0,
  cornerScoreRunNearMisses: 0,
  cornerScoreRunElapsedMs: 0,
  cornerScoreElapsedIntervalId: null,
  cornerScorePersonalBest: null,
  cornerScoreServerStats: null,
  rightMonitorDisplayMode: 'join-discord',
  ...
  whiteboardCornerScoreServerStatsEl: null,
  middleMonitorCornerScoreOverlayEl: null,
  middleMonitorCornerScoreServerStatsEl: null,
  middleMonitorStaticOverlayEl: null,
  middleMonitorStaticVideoEl: null,
  isMiddleMonitorCornerScoreStaticSequenceRunning: false,
  leftMonitorCornerScoreOverlayEl: null,
  ...
  bigTvToolsHeaderTitleEl: null,
  isBigTvToolsActive: false,
  bigTvToolsViewMode: 'menu',
  bigTvToolsSequenceToken: 0,
  bigTvToolsEntries: [],
  bigTvOrchCardsEntries: [],
  bigTvOrchCardDetailIndex: null,
  loginOverlayEl: null,
  ...
  rightMonitorDiscordQuadrantOverlayEl: null,
  ...
  bigTvPersonalBestBannerEl: null,
  bigTvPersonalBestBannerTimeoutId: null,
  bigTvServerHighScoreBannerEl: null,
  bigTvServerHighScoreBannerTimeoutId: null,
  bigTvCornerScoreStatusTimeoutId: null,
  bigTvCornerScoreBottomPanelEl: null,
  bigTvCornerScoreBottomPanelView: null,
  bigTvPbTableBodyEl: null,
  bigTvPbTableRowCount: 0,
  bigTvServerHsTableBodyEl: null,
  bigTvServerHsTableRowCount: 0,
  bigTvPanelCurrentScoreEl: null,
  bigTvPanelCurrentTimeEl: null,
  bigTvPanelCurrentBouncesEl: null,
  bigTvPanelCurrentNearMissesEl: null,
  bigTvPanelServerTotalScoresEl: null,
  bigTvPanelServerTotalBouncesEl: null,
  bigTvPanelServerTotalNearMissesEl: null,
  bigTvPanelServerTotalTimeEl: null,
  bigTvPanelServerTotalRunsEl: null,
  ...
  viewportAuthChipEl: null,
  viewportAuthChipButtonEl: null,
  viewportAuthChipAvatarEl: null,
  viewportAuthChipLabelEl: null,
  viewportAuthChipMenuEl: null,
  viewportAuthLogoutButtonEl: null,
  isViewportAuthChipMenuOpen: false,
  hasInitializedViewportAuthChip: false,
