...
export const GITHUB_SHELF_OBJECT_DVD_IMAGE_URL = 'assets/images/dvd-logo.svg';
...
export const defaultHotspots = [
  ...
  { id: COMMODORE_SHADOW_CONTROL_ID, x: 1579, y: 1080, w: 423, h: 248 },
  ...
  { id: LEFT_MONITOR_SHADOW_LAYER_CONTROL_ID, x: 1130, y: 1062, w: 387, h: 281 },
...
export const overlayDefaults = [
  ...
  { id: LEFT_MONITOR_SHADOW_LAYER_ID, x: LEFT_MONITOR_FRAME_BOUNDS.x, y: LEFT_MONITOR_FRAME_BOUNDS.y - 8, w: LEFT_MONITOR_FRAME_BOUNDS.w, h: LEFT_MONITOR_FRAME_BOUNDS.h + 8 },
  { id: LEFT_MONITOR_SIDE_FRAME_OVERLAY_ID, ...LEFT_MONITOR_FRAME_BOUNDS },
  { id: COMMODORE_SHADOW_OVERLAY_ID, x: 1682, y: 1087, w: 414, h: 206 },
